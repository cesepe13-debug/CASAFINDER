...
export default async function handler(req) {
  ...
  try {
    ...
    return new Response(JSON.stringify({
      error: "No se pudo parsear", title: "", address: "", zone: "",
      price: null, size: null, rooms: null, bathrooms: null,
      trastero: false, garaje: false, terraza: false,
      distanciaKm: null, comunidad: null, notes: "",
    }), {
      status: 200,
      headers: { "Content-Type": "application/json", "Access-Control-Allow-Origin": "*" },
    });
